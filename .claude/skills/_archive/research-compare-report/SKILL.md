---
name: research-compare-report
user-invocable: true
description: Render a finished comparison study into a markdown report — generates a reusable Python script that covers every field and skips uncertain values. Part of the research-compare pipeline — matrix mode, where a known set of things is compared across fixed dimensions to produce a table. For an open question answered as a cited narrative report, use research-agent instead.
allowed-tools: Read, Write, Glob, Bash, AskUserQuestion
---

# Research Compare Report - Render the table

## Trigger
`/research-compare-report`
